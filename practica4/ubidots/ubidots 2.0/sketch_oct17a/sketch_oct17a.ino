 ...
 ****************************************/
const char* UBIDOTS_TOKEN = "BBFF-OQIi5phTOiJ47GHQqDhy0jQ6HhuK6s";  // Put here your Ubidots TOKEN
const char* UBIDOTS_DEVICELABEL = "sensor"; // Device label to use
const char* WIFI_SSID = "iPhone de Juan Pablo";      // Put here your Wi-Fi SSID
const char* WIFI_PASS = "jpdealba";      // Put here your Wi-Fi password
