 ...
 * Define Constants
 ****************************************/
#define WIFISSID "Totalplay-9BA2-5G"                // Put your WifiSSID here
#define PASSWORD "9BA2BF50tCdU4xXf"                 // Put your wifi password here
#define TOKEN "BBFF-OQIi5phTOiJ47GHQqDhy0jQ6HhuK6s" // Put your Ubidots' TOKEN
#define MQTT_CLIENT_NAME "MQTTool-2395655715"       // MQTT client Name, please enter your own 8-12 alphanumeric character ASCII string;
